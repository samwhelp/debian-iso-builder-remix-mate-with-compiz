...
# debian-iso-builder-remix-mate-with-compiz
...
| `+` | `+` |
| [debian-iso-builder-remix-mate-with-compiz](https://samwhelp.github.io/debian-iso-builder-remix-mate-with-compiz/) | [GitHub](https://github.com/samwhelp/debian-iso-builder-remix-mate-with-compiz) |
| `=` | `=` |
| [debian-iso-builder-respin-mate-with-compiz](https://samwhelp.github.io/debian-iso-builder-respin-mate-with-compiz/) | [GitHub](https://github.com/samwhelp/debian-iso-builder-respin-mate-with-compiz) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-remix-mate-with-compiz/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-remix-mate-with-compiz/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-remix-mate-with-compiz/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-remix-mate-with-compiz](https://github.com/samwhelp/debian-iso-builder-remix-mate-with-compiz)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-remix-mate-with-compiz.git
```


> change dir to `debian-iso-builder-remix-mate-with-compiz`

``` sh
cd debian-iso-builder-remix-mate-with-compiz
```
...
> change dir to `~/work/debian-iso-builder-remix-mate-with-compiz/iso-profile`

``` sh
cd ~/work/debian-iso-builder-remix-mate-with-compiz/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/debian-iso-builder-remix-mate-with-compiz/iso-profile/dist`
...
| Link | GitHub |
| ---- | ------ |
| [Debian / Mate with Compiz / Adjustment](https://samwhelp.github.io/debian-mate-with-compiz-adjustment/) | [GitHub](https://github.com/samwhelp/debian-mate-with-compiz-adjustment) |
| [Debian / Mate with Compiz / Note](https://samwhelp.github.io/note-about-debian-mate-with-compiz/) | [GitHub](https://github.com/samwhelp/note-about-debian-mate-with-compiz) |
